...
public class Transaksi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //camera api
        ActivityCompat.requestPermissions(Transaksi.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Transaksi.this, "Foto berhasil disimpan", Toast.LENGTH_SHORT).show();
        ...
        checkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Transaksi.this, Checkout.class);
                ...
                if(index>0)
                {
                    ...
                    if ( spiner.equals("1 Jam")) {
                       ...
                       intent.putExtra("harga", harga.getText());
                        ...
                        harga.setText("Rp. 180.000");
                        intent.putExtra("harga", harga.getText());

                    } else if (spiner.equals("3 Jam")){
                        harga.setText("Rp. 270.000");
                        intent.putExtra("harga", harga.getText());
